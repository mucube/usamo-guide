...
Now, we can find all factors pairs that multiply to $18$: $(1, 18), (2, 9), (3, 6), (6, 3), (9, 2), (18, 1)$

In each pair, we can make $m + 1$ be the left integer and $n + 1$ be the right integer to get $(m, n) = (0, 17), (1, 8), (2, 5), (5, 2), (8, 1), (17, 0)$
